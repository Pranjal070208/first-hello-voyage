  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-[#020617] via-[#08122B] to-[#0A1833]">
      <div className="text-center px-4 max-w-4xl">
        <h1 className="mb-6 text-4xl md:text-6xl lg:text-7xl font-bold text-transparent bg-clip-text bg-gradient-flow animate-fade-down">
          Welcome to Your Blank App
        </h1>
        <p className="text-lg md:text-xl lg:text-2xl text-gray-200 animate-fade-up stagger-1">
          Start building your amazing project here!
        </p>
        <div className="mt-6 md:mt-8 flex justify-center gap-4 animate-zoom-in stagger-2">
