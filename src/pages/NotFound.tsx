  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-[#020617] via-[#08122B] to-[#0A1833]">
      <div className="text-center px-4">
        <h1 className="mb-4 text-8xl font-bold text-transparent bg-clip-text bg-gradient-flow animate-bounce-in">404</h1>
        <p className="mb-8 text-2xl text-gray-200 animate-fade-up stagger-1">Oops! Page not found</p>
        <a 
          href="/" 
