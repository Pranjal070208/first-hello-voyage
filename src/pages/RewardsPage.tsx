        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {[
            ...
            },
            {
              ...
              features: [
                "Personalized by industry experts",
        ...
        <div className="bg-white/10 backdrop-blur-xl border border-yellow-400/20 rounded-2xl p-10 shadow-[0_0_25px_rgba(255,215,0,0.1)] animate-fade-in mb-16">
            ...
            {[
              {
                ...
                prize: "₹5,000",
                perks: [
                  "Premium Entrepreneur Kit",
                  "Featured spotlight for 3 months",
              ...
              },
              {
                ...
                prize: "₹3,000",
                perks: [
                  "Standard Entrepreneur Kit",
                  "Featured spotlight for 2 months",
                  "Mentorship access",
                  "Blockchain certificate"
                ]
              },
              {
                ...
                prize: "₹2,000",
                perks: [
                  "Basic Entrepreneur Kit",
                  "Featured spotlight for 1 month",
              ...
              <div
                key={index}
                className="bg-gradient-to-b from-white/10 to-white/5 border border-yellow-400/30 rounded-xl p-6 text-center hover:scale-105 transition-all"
              >
                <div className="text-4xl mb-4">{item.place}</div>
                <div className="text-5xl font-bold text-transparent bg-clip-text bg-gradient-flow mb-6">
                  {item.prize}
                </div>
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-300 text-lg">
              All finalists receive certificates and letters of recommendation regardless of placement.
            </p>
          </div>
        </div>
